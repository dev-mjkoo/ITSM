(function () {
  const transactionSamples = [
    ...
    ["DT", "BXM", "RSMDE3927A01", "모바일 쿠폰 발급", "BXM40101", "업무처리중 오류가 발생했습니다.", "dtnwa21p", "모바일라이프셀", "디지털뱅킹_국내", "Mobile공통"],
    ["DX", "BXM", "RSMDE7461A01", "자산 정보 동기화", "BXM30002", "거래 처리 중 일시적인 지연이 발생했습니다.", "solwa03p", "마이데이터셀", "디지털뱅킹_국내", "Mobile공통"],
    ...
    ["A0", "PFM", "GSTYJ5086A01", "영업점 거래 조회", "DEP10051", "원장 처리시 오류입니다. 전산담당자에게 문의하세요", "coreap2p", "외환개발셀", "N외국환", "수출"],
